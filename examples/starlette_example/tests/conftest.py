...
from examples.starlette_example.database import connection
from examples.starlette_example.setup_app import lifespan, setup_app


@pytest_asyncio.fixture
async def app() -> AsyncGenerator[Starlette]:
    """
